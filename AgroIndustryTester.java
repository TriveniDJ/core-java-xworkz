public class AgroIndustryTester {
    public static void main(String[] args) {
        ...
        agroIndustry3.name = "Golden Harvest Farms";
        agroIndustry3.location = "Texas";
        agroIndustry3.employees = 60;
        ...
        agroIndustry4.name = "Organic Food Co.";
        agroIndustry4.location = "Florida";
        agroIndustry4.employees = 40;
        ...
        agroIndustry5.name = "Healthy Harvest";
        agroIndustry5.location = "Arizona";
        agroIndustry5.employees = 25;
        ...
        agroIndustry6.name = "Green Life Farms";
        agroIndustry6.location = "Colorado";
        agroIndustry6.employees = 35;
